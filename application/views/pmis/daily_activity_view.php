			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div>
						...
						<table id="dynamic-table-daily-activity" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									<th class="center">
										No.
...
<script>
	$(document).ready(function() {
		...
		//datatables
		var table = $('#dynamic-table-daily-activity').DataTable({
			...
			"ajax": {
				"url": "<?php echo site_url('pmis/ajax_daily_activity?id_project=') ?>" + id_project,
				"type": "POST",
			},
			"searching": false,
