											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td>
														<a href="#"><?php echo $data['nama_kontrak_supervisi']; ?></a>
														</td>
														...
														<td>
														 <input type="hidden" name="id_project" value="<?php echo $data['id_project']; ?>">
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" value="<?php echo $data['id_project']; ?>" href="<?php echo base_url() . "pmis/kontrak_supervisi_edit?id_project =".$data['id_project'] ."&id_kontrak_supervisi=" . $data['id_kontrak_supervisi']; ?>">
																	
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" value="<?php echo $data['id_project']; ?>"  href="<?php echo base_url() . "pmis/kontrak_supervisi_delete?id_project =".$data['id_project'] ."&id_kontrak_supervisi=" . $data['id_kontrak_supervisi']; ?>" onclick="return confirm('Anda Yakin Menghapus Data Ini?');" >
