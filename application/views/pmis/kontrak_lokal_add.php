				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Add Kontrak Lokal</li>
						</ul><!-- /.breadcrumb -->
...
<div class="box-body">
                <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>pmis/aksi_kontrak_lokal_add?id_project=<?php echo $_GET['id_project'];?>" enctype="multipart/form-data">
				...
				<input type="hidden" name="id_project" value="<?php echo $_GET['id_project']; ?>">
                    <div class="box-body">
                        <div class="col-lg-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
								 <input type="text" class="form-control" id="nama_kontrak_lokal" name="nama_kontrak_lokal" required/>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-10">
                    ...
                    <div class="box-footer">
                        <div class="pull-right">
                            <a href="<?php echo base_url(); ?>pmis/kontrak_lokal_view?id_project=<?php echo $_GET['id_project']; ?>" class="btn btn-danger">Kembali</a>
