				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Add Kontrak Engineering</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								Add Kontrak Engineering
								<small>
									<i class="ace-icon fa fa-angle-double-right"></i>
									Tambah Data Kontrak Engineering
								</small>
							</h1>
						</div><!-- /.page-header -->
...
<div class="box-body">
                <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>pmis/aksi_kontrak_engineering_add?id_project=<?php echo $_GET['id_project'];?>" enctype="multipart/form-data">
				
				<input type="hidden" name="id_project" value="<?php echo $_GET['id_project']; ?>">
                    <div class="box-body">
                        <div class="col-lg-10">
                            <div class="form-group">
                                <label for="nama_kontrak_engineering" class="col-sm-3 control-label">Nama Kontrak</label>
                                <div class="col-sm-5">
								 <input type="text" class="form-control" id="nama_kontrak_engineering" name="nama_kontrak_engineering" required/>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-10">
                    ...
                    <div class="box-footer">
                        <div class="pull-right">
                            <a href="<?php echo base_url(); ?>pmis/kontrak_engineering_view?id_project=<?php echo $_GET['id_project']; ?>" class="btn btn-danger">Kembali</a>
