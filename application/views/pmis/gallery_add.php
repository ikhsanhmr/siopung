...
<div class="box-body">
                <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>pmis/aksi_gallery_add?id_project=<?php echo $_GET['id_project'];?>" enctype="multipart/form-data">
				...
				<input type="hidden" name="id_project" value="<?php echo $_GET['id_project']; ?>">
                    <div class="box-body">
                        ...
                        <div class="col-lg-10">
							...
							<label for="upload_foto" class="col-sm-3 control-label">Upload Foto</label>
									 ...
									 <?php echo form_open_multipart('pmis/aksi_gallery_add');?>
                    ...
                    <div class="box-footer">
                        <div class="pull-right">
                            <a href="<?php echo base_url(); ?>pmis/gallery_view?id_project=<?php echo $_GET['id_project']; ?>" class="btn btn-danger">Kembali</a>
