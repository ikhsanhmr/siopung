			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Edit Data Kontrak Engineering</li>
						</ul><!-- /.breadcrumb -->
				...
				<div class="box-body">
                <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>pmis/aksi_kontrak_engineering_edit?id_project=<?php echo $kontr['id_project']; ?>"  enctype="multipart/form-data">
				
				 <input type="hidden" name="id_project" value="<?php echo $kontr['id_project']; ?>">
				 <input type="hidden" name="id_kontrak_engineering" value="<?php echo $kontr['id_kontrak_engineering']; ?>">
                    
                        
                        <div class="box-body">
                        <div class="col-lg-10">
                            <div class="form-group">
                                <label for="nama_kontrak_engineering" class="col-sm-3 control-label">Nama Kontak Utama</label>
                                <div class="col-sm-5">
								 <input type="text" class="form-control" id="nama_kontrak_engineering" name="nama_kontrak_engineering" value="<?php echo $kontr['nama_kontrak_engineering']; ?>" required/>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-10">
					...
					<div  class="space"> </div>
                      <center> <div class="col-sm-10">
                            <a href="<?php echo base_url(); ?>pmis/kontrak_engineering_view?id_project=<?php echo $kontr['id_project']; ?>" class="btn btn-danger">Kembali</a>
