				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Add General Information</li>
						</ul><!-- /.breadcrumb -->
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Tambah Data General Information
								</small>
							</h1>
						</div><!-- /.page-header -->
...
<div class="box-body">
                <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>pmis/aksi_general_information_add?id_project=<?php echo $_GET['id_project'];?>" enctype="multipart/form-data">
				...
				<input type="hidden" name="id_project" value="<?php echo $_GET['id_project']; ?>">
                    <div class="box-body">
							...
							<label for="date_sign_ppa" class="col-sm-3 control-label">Date Sign PPA</label>
                                <div class="col-sm-5">	
															<div class="input-group">
															  ...
															  <input name="date_sign_ppa"  class="form-control date-picker" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
                        ...
                        <div class="col-lg-10">
                            <div class="form-group" >
							<label for="financial_close_date" class="col-sm-3 control-label">Financial Date Close</label>
                                <div class="col-sm-5">	
															<div class="input-group">
															  
															  <input name="financial_close_date"  class="form-control date-picker" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
															  <span class="input-group-addon">
																<i class="fa fa-calendar-o"></i>
															  </span> 
															</div>
						...
						<div class="col-lg-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
								 <input type="text" class="form-control" id="luas_area" name="luas_area" required/>
                                </div>
                            </div>
                        </div>
						...
						<div class="col-lg-10">
							<div class="form-group">
										...
										<div class="col-sm-5">
											<input  type="text" name="tgl_kontrak" class="form-control date-picker" id="tgl_kontrak" type="text" data-date-format="dd-mm-yyyy" />
											<input class="ace" type="checkbox" id="id-disable-check" />
													<span class="lbl"> Proyek Belum Terkontrak!</span>
												
										</div>
									</div>
									<input  type="hidden" name="tgl_kosong"  id="tgl_kosong" tgl_kosong="" class="form-control date-picker" />
                            </div>
						...
						<div class="col-lg-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
								 <input type="text" class="form-control" id="sumber_pendanaan" name="sumber_pendanaan" required/>
                                </div>
                            </div>
                        </div>
						...
						<div class="col-lg-10">
							<div class="form-group">
										...
										<div class="col-sm-5">
											<input  type="text" name="tanggal_efektif" class="form-control date-picker" id="tanggal_efektif" type="text" data-date-format="dd-mm-yyyy" />
											<input class="ace" type="checkbox" id="id-disable-check1" />
													<span class="lbl"> Proyek Belum Efektif!</span>
												
										</div>
									</div>
									<input  type="hidden" name="tgl_kosong1"  id="tgl_kosong1" tgl_kosong1="" class="form-control date-picker" />
                            </div>
						...
						<div class="col-lg-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
								 <input type="text" class="form-control" id="konsultan_desain" name="konsultan_desain" required/>
                                </div>
                            </div>
                        </div>
						...
						<div class="col-lg-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
								 <input type="text" class="form-control" id="konsultan_supervisi" name="konsultan_supervisi" required/>
                                </div>
                            </div>
                        </div>
							...
							<label for="target_cod" class="col-sm-3 control-label">Target COD</label>
                                <div class="col-sm-5">	
															<div class="input-group">
															  ...
															  <input name="target_cod"  class="form-control date-picker" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
															  <span class="input-group-addon">
																<i class="fa fa-calendar-o"></i>
															  </span>
															</div>
                    ...
                    <div class="box-footer">
                        <div class="pull-right">
                            <a href="<?php echo base_url(); ?>pmis/general_information_view?id_project=<?php echo $_GET['id_project']; ?>" class="btn btn-danger">Kembali</a>
