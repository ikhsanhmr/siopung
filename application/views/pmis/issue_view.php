			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div>
						...
						<table id="dynamic-table-issue" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									<th class="center">
										No.
...
<script>
	$(document).ready(function() {
		...
		//datatables
		var table = $('#dynamic-table-issue').DataTable({
			...
			"ajax": {
				"url": "<?php echo site_url('pmis/ajax_issue?id_project=') ?>" + id_project,
				"type": "POST",
			},
			"searching": false,
