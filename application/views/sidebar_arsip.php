				...
				<div class="navbar-header pull-left">
					...
					<a href="#" class="navbar-brand">
							...
							if ($this->session->userdata('admin') == True){
								echo '<small><i class="fa fa-bolt"></i>';
								echo " Sistem Informasi Survei dan Perizinan Pembangkit (Si-Superkit)</small>";
							} else {
							echo '<small><i class="fa fa-leaf"></i>';
								echo " Sistem Informasi Monitoring Proyek Unggul (SI OPUNG) </small>";
							}
